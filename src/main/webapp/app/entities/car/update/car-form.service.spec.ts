      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            carBrand: expect.any(Object),
            carModel: expect.any(Object),
            carBodyType: expect.any(Object),
            carImageUrl: expect.any(Object),
            carYear: expect.any(Object),
            carEngineVolume: expect.any(Object),
            carGearboxType: expect.any(Object),
            carDescription: expect.any(Object),
          })
        );
      });
